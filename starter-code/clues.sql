...
SELECT name, population, region FROM countries WHERE region = 'Southern Europe' ORDER BY population;
...
SELECET name FROM countries WHERE code = 'SMR'
...
SELECT * FROM cities WHERE code = 211;
...
SELECT * FROM cities WHERE population = 91086;

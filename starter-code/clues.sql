...
SELECT code, name, region, population FROM countries WHERE region = 'Southern Europe' ORDER BY population;
...
SELECT countrycode, language, percentage FROM countrylanguages WHERE language = 'Italian' AND percentage > 80;
